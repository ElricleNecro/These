...
\section{Focalisation sur les simulations intéressantes}
	\subsection{Instabilité d'orbite radiale}
		...
		la densité du bain sont les mêmes. Nous pouvons donc en déduire que la dispersion de vitesse du bain, dans l'intervalle de valeur testé,
		...
		cube par $1,5$ afin de vérifier si cette différence n'est pas dû aux conditions périodiques. Pour avoir la simulation la plus
	...
	\subsection{Évolution de la pente avec l'âge (effet de relaxation)}
		...
		différentes graphiques de la figure~\ref{Fig::Relax::Comp} montrent l'évolution de ces nouvelles simulations.
		% (les lignes
		...
		Cette impression est confirmé epar l'étude de l'évolution du \textsc{sag} isolé (simulation sans bain).
		La
