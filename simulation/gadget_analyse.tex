...
\label{Chap::Simu::Analysis}
	...
	\section{Le programme de simulation}
		...
		\subsection{Lissage de la force}
			...
			\end{align*}
			où $\rho_\epsilon$ est la densité d'un volume de rayon $\epsilon$ suffisamment petit pour être
		...
		\subsection{\og\Sm\fg et pas de temps}
			...
			% \begin{align*}
				...
				% \end{cases}
			% \end{align*}
			Le \sm est schéma d'intégration d'ordre 2. Il a la particularité d'introduire un décalage entre l'évaluation des positions et
