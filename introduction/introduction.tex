...
\chapter{Propriétés générales des systèmes auto-gravitants}
	...
	\section{Amas Globulaire}
		...
		% ; le mouvement des étoiles et celui des particules d'un gaz sont eux-mêmes assez différent (~l'un consiste
		...
		%	, que l'on trouve soit près du bulbe galactique, soit dans le halo
		...
		%	Mais restons dans notre galaxie pour le moment : ne serait-ce que dans notre galaxie, les amas globulaire peuvent être très différent les uns des autres :
			...
			% Une partie
			% des amas est concentrée autour du centre galactique tandis que d'autres
			% évoluent dans le halo galactique.

			%\begin{figure}
				%\begin{center}
					%\includegraphics[width=\linewidth]{m15_hst_4089_HD-2.png}
					%\caption{Amas globulaire M15. Cette amas présente un cœur dit effondré.}
				%\end{center}
			%\end{figure}

			%\begin{figure}
				%\begin{center}
					%\includegraphics[width=\linewidth]{ngc5139_w-cen_HD-2.png}
					%\caption{Amas globulaire NGC5139. Cette amas ne présente pas le cœur effondré.}
				%\end{center}
			%\end{figure}
		...
		\subsection{Répartition}
			...
			\begin{figure}
				...
				\todo[inline]{translater le centre du soleil vers le centre galactique pour une meilleurs visualisation.}
			\end{figure}
		...
		\subsection[Lien]{Lien entre données et paramètres\label{amas}}
			%\todo[inline]{Dois je laisser cette section ici?}
