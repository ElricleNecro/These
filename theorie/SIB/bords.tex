...
\subsubsection{Au centre de la sphère: $x = 0$}
	...
	En utilisant~\refeq{syst_uv} nous trouvons alors:
	\begin{align}
	...
	\end{align}
	Soit $a = \frac{1}{6}$ et $b=0$, puis en utilisant~\refeq{vDL} et~\refeq{uDL} nous trouvons finalement:
	$$\lim_{r\to 0}(u,v) = (3,0)$$

\subsubsection{Sur le bord de la sphère: $r = R$}
	Commençons par introduire quelques quantités sans dimension utiles: % quelques constantes sans dimensions dimensionnées fort utiles 
	\begin{align}
		\begin{array}{rll}
