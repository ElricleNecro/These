...
\end{align}
Le seul point d'équilibre est l'origine $\mathbf{z}_0=\left[  0,0\right]
...
\end{itemize}
Les trois propriétés énumérées ci-dessus font de la fonction $\mathcal{E}$ une fonction de Lyapounov\index{Fonction! de Ljapounov}\index{Ljapounov, fonction de} stricte du système, l'équilibre $\mathbf{z}_0$ est donc globalement asymptotiquement stable. 
...
\end{align*}
En majorant les fonctions trigonométriques, on a donc $\zeta\left(
