...
\chapter{Étude de quelques amas}
	...
	\section{Introduction}
		\input{theorie/Amas/pente-intro.tex}
...
%			Pour les autres paramètres comme le rayon de cœur, le problème reste entier.
		\input{theorie/Amas/pente-lien.tex}

	\section{Interprétation}
		\input{theorie/Amas/pente-amas.tex}
...
%			avec laquelle il diminue va elle aussi changer.
		\input{theorie/Amas/scenario.tex}

\chapter{Toy Model : Un modèle simplifié\label{chp::toymodel}}
	\minitoc

	\section{Hypothèse et simplification}
		\input{theorie/ToyModel/hyp.tex}

	\section{Cas Général}
		\input{theorie/ToyModel/casall.tex}

	\section{Cas $\alpha  = 4$}
		\input{theorie/ToyModel/cas4.tex}
