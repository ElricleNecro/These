...
suffisament petit. Leurs résultat est contraire à celui proposé par \cite{waterbag}, et va dans
...
dans 3 conditions initales de vitesse déterminées par le rapport du viriel initial : $-2T/U=0.5,~0.2$ et $0.1$. Le résultat est clair : les sphères
