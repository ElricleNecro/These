...
\begin{document}
	...
	\addstarredchapter{Remerciements}
		...
		m'avoir permis de faire cette thèse sur un sujet aussi intéressant. Merci à tous les deux de votre
		disponibilité, de votre soutien, et de votre aide, et surtout de votre patience lors de la difficile
		...
		rapporteurs de ma thèse. Merci à Françoise Combes et Julien Devriendt pour avoir accepté de faire partie
		du jury.

		Je remercie les deux maitres de l'informatique de l'UMA: Christophe Mathulik pour son aide sur le
		...
		programmation que tu m'as fais découvrir. Un grand merci à mon prédécesseur Nicolas Kielbasiewicz pour
		ses conseils et nos longues discussions.

		Un grand merci à tout les doctorants de l'UMA et de l'IAP pour leur accueil et l'ambiance qu'ils mettent
		au laboratoire, il y en a trop pour que je puisse tous vous citer, mais je pense à tous! Plus
		particulièrement, merci à Geoffrey et Laure pour m'avoir proposé leurs soutiens lors de cette fin de
		thèse, au moment où j'en avais besoin.

		Merci aux membres de l'UMA pour l'ambiance très agréable et accueillante qu'ils donnent au laboratoire.

		Je me doit de remercier grandement mon co-bureau de l'IAP, Manuel Duarte, qui passa sa thèse à tenter de
		...
		pour leurs soutiens indéfectible et toute nos soirées et sorties!

		Pour terminer, je remercie ma famille qui m'a soutenue et encouragée jusqu'au bout, me permettant de me
